                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-4 gap-4 mb-4">
                    <div className="text-center p-2 bg-purple-50 rounded">
                      <p className="text-xs text-gray-600">Political</p>
                      <p className={`text-xl font-semibold ${getScoreColor(analysis.political)}`}>
                    ...
                    <div className="text-center p-2 bg-blue-50 rounded">
                      ...
                      <p className={`text-xl font-semibold ${getScoreColor(analysis.social)}`}>
                        {analysis.social}/10
                      </p>
                    </div>
                    <div className="text-center p-2 bg-orange-50 rounded">
                      <p className="text-xs text-gray-600">Technological</p>
                      <p className={`text-xl font-semibold ${getScoreColor(analysis.technological)}`}>
                        {analysis.technological}/10
                      </p>
                    </div>
                  </div>
