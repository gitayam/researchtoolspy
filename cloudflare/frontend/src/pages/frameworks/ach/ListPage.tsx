...
export default function ACHListPage() {
  ...
  const handleView = (id: number) => {
    navigate(`/frameworks/ach/${id}`)
  }

  const handleEdit = (id: number) => {
    navigate(`/frameworks/ach/edit/${id}`)
  }

  const handleCreate = () => {
    navigate('/frameworks/ach/create')
  }
          ...
          <div className="flex justify-between items-start">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem onClick={() => handleView(analysis.id)}>
                  View
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => handleEdit(analysis.id)}>
                  Edit
                </DropdownMenuItem>
                <DropdownMenuItem
