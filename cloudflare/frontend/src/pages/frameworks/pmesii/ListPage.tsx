  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-7xl">
      <div className="flex justify-between items-center mb-8">
        ...
        <Link to="/frameworks/pmesii-pt/create">
          <Button>
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <Link to={`/frameworks/pmesii-pt/${analysis.id}`}>
                  ...
                  <div className="flex items-center gap-6 text-sm">
                    <div>
                      ...
                      <span className="ml-2 font-medium">{analysis.domains}/8</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Critical Factors:</span>
                      <span className="ml-2 font-medium">{analysis.criticalFactors}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Completeness:</span>
                      <span className={`ml-2 font-medium ${getCompletenessColor(analysis.completeness)}`}>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem asChild>
                      <Link to={`/frameworks/pmesii-pt/${analysis.id}`}>View</Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                      <Link to={`/frameworks/pmesii-pt/${analysis.id}/edit`}>Edit</Link>
                    </DropdownMenuItem>
