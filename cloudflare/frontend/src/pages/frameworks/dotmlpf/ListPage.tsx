  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-7xl">
      <div className="flex justify-between items-center mb-8">
        ...
        <Link to="/frameworks/dotmlpf/create">
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <Link to={`/frameworks/dotmlpf/${analysis.id}`}>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => navigate(`/frameworks/dotmlpf/${analysis.id}`)}>
                          View
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => navigate(`/frameworks/dotmlpf/${analysis.id}/edit`)}>
                          Edit
                        </DropdownMenuItem>
                        <DropdownMenuItem
