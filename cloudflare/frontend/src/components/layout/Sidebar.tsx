...
const navigation = [
  { name: 'Dashboard', href: '/dashboard', icon: Home },
  {
    ...
    icon: Brain,
    children: [
      { name: 'SWOT Analysis', href: '/frameworks/swot' },
      { name: 'COG Analysis', href: '/frameworks/cog' },
      { name: 'PMESII-PT', href: '/frameworks/pmesii-pt' },
      { name: 'ACH Analysis', href: '/frameworks/ach' },
      { name: 'DOTMLPF', href: '/frameworks/dotmlpf' },
      { name: 'DIME Analysis', href: '/frameworks/dime' },
      { name: 'Behavioral Analysis', href: '/frameworks/behavior' },
      { name: 'Starbursting', href: '/frameworks/starbursting' },
      { name: 'Causeway', href: '/frameworks/causeway' },
      { name: 'PEST Analysis', href: '/frameworks/pest' },
      { name: 'VRIO Analysis', href: '/frameworks/vrio' },
      { name: 'Stakeholder Analysis', href: '/frameworks/stakeholder' },
      { name: 'Surveillance Analysis', href: '/frameworks/surveillance' },
      { name: 'Trend Analysis', href: '/frameworks/trend' },
      { name: 'Fundamental Flow', href: '/frameworks/fundamental-flow' },
      { name: 'Deception Detection', href: '/frameworks/deception' },
    ]
  },
  {
    name: 'Research Tools',
