...
ALTER TABLE framework_sessions ADD COLUMN version INTEGER DEFAULT 1;   -- Version number for updates
...
CREATE INDEX IF NOT EXISTS idx_framework_sessions_library
  ON framework_sessions(published_to_library, is_public)
...
-- Assumes workspace ID "1" (default workspace) exists from migration 005
...
-- ============================================================
-- ADD WORKSPACE FIELDS TO ACH ANALYSES (if exists)
-- ============================================================
...
ALTER TABLE ach_analyses ADD COLUMN version INTEGER DEFAULT 1;

CREATE INDEX IF NOT EXISTS idx_ach_analyses_workspace ON ach_analyses(workspace_id);
CREATE INDEX IF NOT EXISTS idx_ach_analyses_library ON ach_analyses(published_to_library, is_public);
...
-- 5. Version tracking prepares for future change tracking feature
-- ============================================================
