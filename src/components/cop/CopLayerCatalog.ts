...
export const COP_LAYERS: CopLayerDef[] = [
  // ── Entity Layers ────────────────────────────────────────
  {
    ...
    defaultFor: ['quick_brief', 'event_monitor', 'area_study', 'crisis_response', 'event_analysis', 'custom'],
    filterable: true,
  ...
  },
  {
    ...
    defaultFor: ['event_monitor', 'area_study', 'crisis_response', 'event_analysis', 'custom'],
    filterable: true,
  ...
  },
  {
    ...
    defaultFor: ['area_study', 'crisis_response', 'event_analysis'],
    filterable: true,
  ...
  // ── External Layers ──────────────────────────────────────
  {
    ...
    defaultFor: ['event_monitor', 'crisis_response', 'event_analysis'],
    filterable: true,
  ...
  },
  {
    ...
    defaultFor: ['event_monitor', 'event_analysis'],
    filterable: false,
  },
  ...
  // ── Tactical Layers ──────────────────────────────────────
  {
    ...
    defaultFor: ['crisis_response', 'event_analysis'],
    filterable: false,
  },
  {
    id: 'user-drawings',
