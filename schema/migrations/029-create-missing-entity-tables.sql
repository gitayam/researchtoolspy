-- Migration 029: Create Missing Entity Tables
-- This migration creates only the entity tables that don't exist yet
-- (workspaces and workspace_members already exist, evidence_items already has all needed columns)
-- Date: October 8, 2025
...
CREATE TABLE IF NOT EXISTS actors (
  ...
  source_url TEXT, -- URL of the source where this actor was extracted from
...
CREATE INDEX IF NOT EXISTS idx_actors_source_url ON actors(source_url);
