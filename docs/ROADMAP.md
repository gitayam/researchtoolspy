...
**Suggested entry point:** A1 SAT quick-wins (low-risk warm-up on the config path) → A2 Indicators → C-Phase-2 Reliability Engine → B Game Theory MVP. Full rationale + sequencing in the plan doc.
