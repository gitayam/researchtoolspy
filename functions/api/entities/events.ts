 ...
 * GET /api/entities/events?search=...&limit=...&workspace_id=...
 *
 * Lightweight search endpoint used by EventLinker components.
 * Returns matching events by title (LIKE search).
 */
...
export const onRequestGet: PagesFunction<Env> = async (context) => {
  ...
  try {
    ...
    console.error('Entity events search error:', error)
    return new Response(
