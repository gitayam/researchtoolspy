/**
 * Behaviour Change Wheel canonical reference data — server-side.
 *
 * Source of truth for the BCW canon as exposed by the COM-B Analysis API.
 * Mirrors src/utils/behaviour-change-wheel.ts and src/utils/bct-taxonomy.ts
 * (client-side equivalents) but inlined here because Cloudflare Pages
