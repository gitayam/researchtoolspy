...
const entries: InventoryEntry[] = [
  ...
  { id: 'INV-019', file: 'functions/api/content-intelligence/social-extract.ts', status: 'constrained-provider', evidence: /parseCanonicalInstagramUrl\(url\)/, forbidden: [/function extractYouTubeId/, /function fetchYouTubeTranscript/, /function extractInstagram\(/, /instagram_oembed/, /query_hash=/, /__a=1/], typecheck: 'root' },
  { id: 'INV-020', file: 'functions/api/content-intelligence/social-media-extract.ts', status: 'constrained-provider', evidence: /parseCanonicalInstagramUrl\(url\)/, forbidden: [/function extractYouTubeVideoId/, /function fetchYouTubeTranscript/, /function extractInstagramVia/, /snapinsta\.app/, /instadp\.com/, /saveinsta\.app/, /api\.instagram\.com\/oembed/], typecheck: 'root' },
  {
    id: 'INV-021',
