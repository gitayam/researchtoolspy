...
const contractTests = [
  ...
  'timeline-artifact-cors', 'timeline-evidence-contract', 'timeline-source-evaluation-contract', 'timeline-epistemic-type-contract', 'timeline-support-warning-contract', 'timeline-source-coverage-contract', 'timeline-timelinejs-contract', 'timeline-judgments-contract', 'timeline-source-import-d1', 'timeline-source-candidates-d1', 'timeline-chunk-import-d1', 'timeline-service-d1', 'timeline-artifact-migrations', 'timeline-workspace-snapshot-d1',
]
const uiTests = ['timeline-tool-ui', 'timeline-workspace-ordering', 'timeline-narrative-ui', 'timeline-durable-browser', 'timeline-evidence-browser', 'timeline-judgments-browser', 'timeline-timelinejs-browser']
const checks = [
